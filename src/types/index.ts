...
// Note: The canonical APIProviderConfig with full fields (headers, transformRequest, etc.)
// lives in services/APIClient.ts. This simplified duplicate has been removed (M28).
...
export interface ElectronAPI {
  ...
  onMenuNewConversation: (callback: () => void) => (() => void) | void
  onMenuSaveConversation: (callback: () => void) => (() => void) | void
